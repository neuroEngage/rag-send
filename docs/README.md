...
This directory contains cell-by-cell code documentation and exact captured outputs for every notebook in the Yelp RAG pipeline.

## Documentation Index

1. **[01_read_gold_documents.md](file:///c:/Users/shank/Downloads/yelp_project/docs/01_read_gold_documents.md)**
...
2. **[02_chunk_documents.md](file:///c:/Users/shank/Downloads/yelp_project/docs/02_chunk_documents.md)**
...
3. **[03_generate_embeddings.md](file:///c:/Users/shank/Downloads/yelp_project/docs/03_generate_embeddings.md)**
...
4. **[04_build_and_query_rag.md](file:///c:/Users/shank/Downloads/yelp_project/docs/04_build_and_query_rag.md)**
